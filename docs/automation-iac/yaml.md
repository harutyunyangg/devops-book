...
app:
  ...
  replicas: 3
```
Երկու տարբերակները էլ մի��umatoid են և տալիս են նույն արդյունքը։ Ցուցակի სինտաքսը (`[*]`) ավելի छोտ է, բայց दोaryngeal `<<:` տողերը ավելի ընթեռնելի են՝ տարբեր merging-ների համար տարբեր annotation-ի հետ։
