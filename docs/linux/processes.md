...
- Բացատրել, թե ինչ է process-ը և PID-ը։
- Տարբերել program, process և thread հասկացությունները։
- `ps`, `top`, `pgrep`, `kill` հրամաններով ախտորոշել գործընթացներ։
- Անվտանգ հերթականությամբ դադարեցնել խափանված process-ը։
...
### Ինչո՞ւ չպետք է ուղղակի `kill -9` անել

Որովհետև ծառայությունը չի հասցնի փակել connections-ը, գրել buffer-ները կամ կատարել cleanup։ Դա կարող է բերել տվյալների կորստի կամ կիսատ գործողությունների։
...
Շարունակիր filesystem permissions կամ systemd թեմայով։ Նախքան անցնելը համոզվիր, որ կարող ես գտնել process-ը, հասկանալ դրա parent-ը և անվտանգ ավարտել քո ստեղծած test process-ը։
